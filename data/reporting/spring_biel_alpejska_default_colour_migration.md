...
`data/imports/configuration_values/spring_biel_alpejska_default_colour_20260802.json`.
...
`post_spring_biel_alpejska_priority_selection_review_001` must record the supplied-cable architecture decision before any charging-cable mutation.
