...
- Missing technical slots: 115
- Missing equipment slots: 42
- Explicitly classified not applicable: 0
- Candidates excluded from selection after an exhausted-source review: 4
...
2. `sandero` / `src_pl_sandero_stepway_expression_ecog120_at_20260626` — technical 16, equipment 4, weighted impact 52 — eligible.
3. `sandero` / `src_pl_sandero_stepway_extreme_ecog120_at_20260626` — technical 14, equipment 4, weighted impact 46 — eligible.
4. `sandero` / `src_pl_sandero_stepway_catalog_tce_slice_20260703` — technical 9, equipment 0, weighted impact 27 — eligible.
