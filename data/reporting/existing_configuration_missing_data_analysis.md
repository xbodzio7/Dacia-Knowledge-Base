...
- Missing technical slots: 111
- Missing equipment slots: 40
- Explicitly classified not applicable: 0
- Candidates excluded from selection after an exhausted-source review: 5
...
2. `sandero` / `src_pl_sandero_stepway_extreme_ecog120_at_20260626` — technical 18, equipment 4, weighted impact 58 — eligible.
3. `sandero` / `src_pl_sandero_stepway_catalog_tce_slice_20260703` — technical 9, equipment 0, weighted impact 27 — eligible.
4. `sandero` / `src_pl_sandero_stepway_expression_ecog120_at_20260626` — technical 8, equipment 2, weighted impact 26 — excluded from selection by `sandero_stepway_expression_auto_source_gap_review.json`.
