...
class JoggerTce110ManualReportingScopeTests(unittest.TestCase):
    ...
    def test_source_coverage_is_complete_for_technical_equipment_and_prices(self) -> None:
        ...
        self.assertEqual(self.coverage["sections"]["covered"], self.coverage["sections"]["denominator"])
        self.assertEqual(self.coverage["sections"]["missing"], 0)
        self.assertEqual(self.coverage["sections"]["not_applicable"], 0)
        self.assertEqual(self.coverage["sections"]["partial"], 0)
        self.assertEqual(self.coverage["sections"]["source_missing"], 0)
    ...
    def test_comparison_summary_has_complete_denominators(self) -> None:
        ...
        self.assertEqual(summary["technical"]["comparisons"], 360)
