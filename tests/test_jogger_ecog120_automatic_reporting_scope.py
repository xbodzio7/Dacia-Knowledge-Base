...
class JoggerEcoG120AutomaticReportingScopeTests(unittest.TestCase):
    ...
    def test_source_coverage_is_complete_for_technical_equipment_and_prices(self) -> None:
        ...
        self.assertEqual(self.coverage["sections"], {"covered": 124, "denominator": 124, "missing": 0, "not_applicable": 0, "partial": 0, "source_missing": 0})
        self.assertEqual(self.coverage["records"]["technical"]["present"], 216)
    ...
    def test_comparison_summary_is_stable(self) -> None:
        self.assertEqual(
            self.comparison["summary"],
            {
                ...
                "technical": {"comparisons": 368, "equal": 288, "different": 40, "not_comparable": 40},
