...
AS_OF = "2026-07-03"
SPEC = REPOSITORY / "data/reporting/jogger_ecog120_automatic_completeness_20260703.json"
...
class JoggerEcoG120AutomaticReportingScopeTests(unittest.TestCase):
    ...
    def test_scope_selects_exactly_four_configurations_and_denominators(self) -> None:
        ...
        self.assertEqual(scope["technical_slots"], 52)
    ...
    def test_source_coverage_is_complete_for_technical_equipment_and_prices(self) -> None:
        ...
        self.assertEqual(self.coverage["sections"], {"covered": 120, "denominator": 120, "missing": 0, "not_applicable": 0, "partial": 0, "source_missing": 0})
        self.assertEqual(self.coverage["records"]["technical"]["present"], 208)
    ...
    def test_comparison_summary_is_stable(self) -> None:
        self.assertEqual(
            self.comparison["summary"],
            {
                ...
                "technical": {"comparisons": 356, "equal": 276, "different": 40, "not_comparable": 40},
