...
class DataProductReleaseTests(unittest.TestCase):
    ...
    def test_manifest_summary_and_canonical_assets(self) -> None:
        ...
        self.assertEqual(self.manifest["selected_configuration_count"], 67)
        self.assertEqual(self.manifest["scope_group_count"], 17)
        self.assertEqual(self.manifest["comparable_scope_count"], 17)
    ...
    def test_shortlist_contains_all_active_configurations_and_formats(self) -> None:
        ...
        self.assertEqual(report["summary"]["active_configurations"], 67)
        self.assertEqual(report["summary"]["matched_configurations"], 67)
        self.assertEqual(len(report["results"]), 67)
    ...
    def test_full_bundle_contains_all_scopes_and_workbook(self) -> None:
        ...
        self.assertEqual(bundle["selected_configuration_count"], 67)
        self.assertEqual(bundle["scope_group_count"], 17)
        self.assertEqual(bundle["comparable_scope_count"], 17)
        self.assertEqual(bundle["singleton_scope_count"], 0)
        self.assertFalse(bundle["cross_scope_pairs_generated"])
        self.assertEqual(len(bundle["groups"]), 17)
    ...
    def test_release_notes_have_no_volatile_metadata(self) -> None:
        ...
        self.assertIn("Selected configurations: 67", notes)
        self.assertIn("Independent scopes: 17", notes)
