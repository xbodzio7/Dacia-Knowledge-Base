...
class DataProductReleaseTests(unittest.TestCase):
    ...
    def test_manifest_summary_and_canonical_assets(self) -> None:
        ...
        self.assertEqual(self.manifest["selected_configuration_count"], 78)
        self.assertEqual(self.manifest["scope_group_count"], 20)
        self.assertEqual(self.manifest["model_family_count"], 5)
        self.assertTrue(self.manifest["cross_model_view_generated"])
        self.assertEqual(self.manifest["comparable_scope_count"], 20)
    ...
    def test_shortlist_contains_all_active_configurations_and_formats(self) -> None:
        ...
        self.assertEqual(report["summary"]["active_configurations"], 78)
        self.assertEqual(report["summary"]["matched_configurations"], 78)
        self.assertEqual(len(report["results"]), 78)
    ...
    def test_full_bundle_contains_all_scopes_and_workbook(self) -> None:
        ...
        self.assertEqual(bundle["selected_configuration_count"], 78)
        self.assertEqual(bundle["scope_group_count"], 20)
        self.assertEqual(bundle["comparable_scope_count"], 20)
        self.assertEqual(bundle["singleton_scope_count"], 0)
        self.assertFalse(bundle["cross_scope_pairs_generated"])
        self.assertEqual(len(bundle["groups"]), 20)
    ...
    def test_cross_model_view_is_included_without_new_pairs(self) -> None:
        ...
        self.assertEqual(view["summary"]["reporting_scope_count"], 20)
        self.assertEqual(view["summary"]["active_configuration_count"], 78)
        self.assertEqual(view["summary"]["within_scope_pair_count"], 129)
        self.assertFalse(view["summary"]["cross_scope_pairs_generated"])
        self.assertEqual(rendered.count('class="model-card"'), 5)
        self.assertEqual(rendered.count('class="scope-card"'), 20)
    ...
    def test_release_notes_have_no_volatile_metadata(self) -> None:
        ...
        self.assertIn("Selected configurations: 78", notes)
        self.assertIn("Independent scopes: 20", notes)
