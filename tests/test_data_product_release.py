...
class DataProductReleaseTests(unittest.TestCase):
    ...
    def test_shortlist_contains_all_active_configurations_and_formats(self) -> None:
        ...
        self.assertEqual(report["summary"]["active_configurations"], 72)
        self.assertEqual(report["summary"]["matched_configurations"], 72)
    ...
    def test_full_bundle_contains_all_scopes_and_workbook(self) -> None:
        ...
        self.assertEqual(bundle["selected_configuration_count"], 72)
        self.assertEqual(bundle["scope_group_count"], 19)
        self.assertEqual(bundle["comparable_scope_count"], 19)
        self.assertEqual(bundle["singleton_scope_count"], 0)
        self.assertFalse(bundle["cross_scope_pairs_generated"])
        self.assertEqual(len(bundle["groups"]), 19)
