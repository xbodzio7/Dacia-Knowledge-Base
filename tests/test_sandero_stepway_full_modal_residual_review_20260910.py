...
from tools.review_sandero_stepway_full_modal_residual_20260910 import (
    NEGATIVE,
...
REPORT = ROOT / "data/reporting/sandero_stepway_full_modal_residual_review_20260910.json"
