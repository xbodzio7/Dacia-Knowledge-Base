...
AS_OF = "2026-07-03"
SPEC = REPOSITORY / "data/reporting/jogger_ecog120_manual_completeness_20260703.json"
EVIDENCE = REPOSITORY / "data/reporting/jogger_ecog120_manual_gap_evidence_20260703.spec"
CONFIGURATIONS = {
...
class JoggerEcoG120ManualReportingScopeTests(unittest.TestCase):
    @classmethod
    ...
    def test_comparison_summary_is_stable(self) -> None:
        self.assertEqual(
            self.comparison["summary"],
            {
                ...
                "technical": {"comparisons": 885, "equal": 705, "different": 90, "not_comparable": 90},
