...
class DusterTechnicalSpecificationTests(unittest.TestCase):
    ...
    def test_repository_totals_match_technical_package(self) -> None:
        ...
        self.assertEqual(len(list(SPECS.glob("*.json"))), 44)
