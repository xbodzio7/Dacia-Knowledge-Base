...
* The automated test suite now contains 476 tests.
* The verified master-data baseline now contains 34 CSV files and 3753 rows.
* SQLite verification now covers 34 tables and 3753 rows.
* Configuration attribute values now contain 1128 dated records.
* Declarative configuration-value imports now contain 65 versioned JSON specifications.
* The canonical catalogue now contains 352 attributes in 30 categories.
