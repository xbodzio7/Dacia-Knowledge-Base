...
* The automated test suite now contains 1648 tests.
* The verified master-data baseline now contains 46 CSV files and 11284 rows.
* SQLite verification now covers 46 tables and 11284 rows.
* Configuration attribute values now contain 3425 dated records.
* Declarative scalar configuration-value imports now contain 131 versioned JSON specifications.
