...
* The automated test suite now contains 1633 tests.
* The verified master-data baseline now contains 46 CSV files and 11220 rows.
* SQLite verification now covers 46 tables and 11220 rows.
* Configuration attribute values now contain 3361 dated records.
* Declarative scalar configuration-value imports now contain 127 versioned JSON specifications.
