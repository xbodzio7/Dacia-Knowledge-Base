...
* The automated test suite now contains 1595 tests.
* The verified master-data baseline now contains 46 CSV files and 11162 rows.
* SQLite verification now covers 46 tables and 11162 rows.
* Configuration attribute values now contain 3307 dated records.
* Declarative scalar configuration-value imports now contain 123 versioned JSON specifications.
