...
* The automated test suite now contains 1610 tests.
* The verified master-data baseline now contains 46 CSV files and 11179 rows.
* SQLite verification now covers 46 tables and 11179 rows.
* Configuration attribute values now contain 3324 dated records.
* Declarative scalar configuration-value imports now contain 125 versioned JSON specifications.
