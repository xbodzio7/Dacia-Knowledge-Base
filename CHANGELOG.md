...
* The automated test suite now contains 1889 tests.
* The verified master-data baseline now contains 47 CSV files and 11776 rows.
* SQLite verification now covers 47 tables and 11776 rows.
