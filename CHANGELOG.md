...
* The automated test suite now contains 536 tests.
* The verified master-data baseline now contains 37 CSV files and 3989 rows.
* SQLite verification now covers 37 tables and 3989 rows.
