...
* The automated test suite now contains 1587 tests.
* The verified master-data baseline now contains 46 CSV files and 11156 rows.
* SQLite verification now covers 46 tables and 11156 rows.
* Configuration attribute values now contain 3301 dated records.
* Declarative scalar configuration-value imports now contain 121 versioned JSON specifications.
