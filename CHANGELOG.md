...
* Declarative scalar configuration-value imports now contain 140 versioned JSON specifications.
* Configuration value ranges now contain 425 dated records from 24 range specifications.
