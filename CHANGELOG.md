...
* The automated test suite now contains 875 tests.
* The verified master-data baseline now contains 46 CSV files and 9019 rows.
* SQLite verification now covers 46 tables and 9019 rows.
