...
* The automated test suite now contains 1763 tests.
* The verified master-data baseline now contains 46 CSV files and 11691 rows.
* SQLite verification now covers 46 tables and 11691 rows.
* Configuration attribute values now contain 3565 dated records.
...
* Equipment availability now contains 5905 records: 4591 `standard`, 514 `optional`, 800 `not_available` and 0 `unknown`.
