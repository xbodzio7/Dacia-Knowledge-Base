...
* The automated test suite now contains 1669 tests.
* The verified master-data baseline now contains 46 CSV files and 11357 rows.
* SQLite verification now covers 46 tables and 11357 rows.
