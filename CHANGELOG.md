...
* The automated test suite now contains 482 tests.
* The verified master-data baseline now contains 34 CSV files and 3799 rows.
* SQLite verification now covers 34 tables and 3799 rows.
* Configuration attribute values now contain 1172 dated records.
* Declarative configuration-value imports now contain 67 versioned JSON specifications.
* The canonical catalogue now contains 354 attributes in 30 categories.
