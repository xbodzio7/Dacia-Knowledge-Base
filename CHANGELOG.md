...
* The automated test suite now contains 681 tests.
* The verified master-data baseline now contains 41 CSV files and 5668 rows.
* SQLite verification now covers 41 tables and 5668 rows.
