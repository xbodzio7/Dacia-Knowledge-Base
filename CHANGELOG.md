...
* The automated test suite now contains 1602 tests.
* The verified master-data baseline now contains 46 CSV files and 11176 rows.
* SQLite verification now covers 46 tables and 11176 rows.
* Configuration attribute values now contain 3321 dated records.
* Declarative scalar configuration-value imports now contain 124 versioned JSON specifications.
