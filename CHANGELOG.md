...
* The automated test suite now contains 1655 tests.
* The verified master-data baseline now contains 46 CSV files and 11306 rows.
* SQLite verification now covers 46 tables and 11306 rows.
* Configuration attribute values now contain 3447 dated records.
* Declarative scalar configuration-value imports now contain 132 versioned JSON specifications.
