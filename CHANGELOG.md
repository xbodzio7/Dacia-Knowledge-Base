...
* The automated test suite now contains 1640 tests.
* The verified master-data baseline now contains 46 CSV files and 11242 rows.
* SQLite verification now covers 46 tables and 11242 rows.
* Configuration attribute values now contain 3383 dated records.
* Declarative scalar configuration-value imports now contain 128 versioned JSON specifications.
