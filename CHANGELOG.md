...
* The automated test suite now contains 1929 tests.
* The verified master-data baseline now contains 47 CSV files and 17327 rows.
* SQLite verification now covers 47 tables and 17327 rows.
