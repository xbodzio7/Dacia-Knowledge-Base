...
* The automated test suite now contains 512 tests.
* The verified master-data baseline now contains 37 CSV files and 3845 rows.
* SQLite verification now covers 37 tables and 3845 rows.
