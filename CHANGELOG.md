...
* The automated test suite now contains 1788 tests.
* The verified master-data baseline now contains 46 CSV files and 11715 rows.
* SQLite verification now covers 46 tables and 11715 rows.
* Configuration attribute values now contain 3567 dated records.
...
* Equipment availability now contains 5906 records: 4592 `standard`, 514 `optional`, 800 `not_available` and 0 `unknown`.
