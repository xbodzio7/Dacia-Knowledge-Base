...
* The automated test suite now contains 1618 tests.
* The verified master-data baseline now contains 46 CSV files and 11190 rows.
* SQLite verification now covers 46 tables and 11190 rows.
* Configuration attribute values now contain 3335 dated records.
* Declarative scalar configuration-value imports now contain 126 versioned JSON specifications.
* Configuration value ranges now contain 274 dated records from 21 range specifications.
