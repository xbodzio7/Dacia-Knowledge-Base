...
- 681 testów automatycznych zakończonych powodzeniem,
- 41 pliki CSV w `data/master`,
- 5668 rekordów danych,
...
- 3156 rekordów w `configuration_attribute_availability.csv`,
- 2401 rekordów `standard`, 375 `optional`, 380 `not_available` i 0 `unknown`,
- 358 kanonicznych atrybutów w 30 kategoriach,
- baza SQLite obejmująca 41 tabele i 5668 rekordów,
