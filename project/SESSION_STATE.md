...
- 476 testów automatycznych zakończonych powodzeniem,
- 34 pliki CSV w `data/master`,
- 3753 rekordów danych,
- 34 relacje między tabelami,
- 19 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 1128 obserwacji w `configuration_attribute_values.csv`,
- 65 wersjonowanych specyfikacji w `data/imports/configuration_values`,
...
- 352 kanonicznych atrybutów w 30 kategoriach,
- baza SQLite obejmująca 34 tabele i 3753 rekordów,
