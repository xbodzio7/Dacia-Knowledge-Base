...
- 735 testów automatycznych zakończonych powodzeniem,
- 41 pliki CSV w `data/master`,
- 7813 rekordów danych,
- 43 relacje między tabelami,
- 21 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 1765 obserwacji w `configuration_attribute_values.csv`,
...
- 4551 rekordów w `configuration_attribute_availability.csv`,
- 3522 rekordów `standard`, 467 `optional`, 562 `not_available` i 0 `unknown`,
- 381 kanonicznych atrybutów w 30 kategoriach,
- baza SQLite obejmująca 41 tabele i 7813 rekordów,
