...
- 1722 testów automatycznych zakończonych powodzeniem,
- 46 pliki CSV w `data/master`,
- 11660 rekordów danych,
- 51 relacje między tabelami,
- 25 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 3552 obserwacji w `configuration_attribute_values.csv`,
- 138 wersjonowanych specyfikacji w `data/imports/configuration_values`,
- 301 obserwacji w `configuration_attribute_value_ranges.csv`,
...
- baza SQLite obejmująca 46 tabele i 11660 rekordów,
