...
- 795 testów automatycznych zakończonych powodzeniem,
- 46 pliki CSV w `data/master`,
- 8497 rekordów danych,
- 51 relacje między tabelami,
- 25 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 1986 obserwacji w `configuration_attribute_values.csv`,
...
- baza SQLite obejmująca 46 tabele i 8497 rekordów,
