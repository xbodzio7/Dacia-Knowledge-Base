...
- 1766 testów automatycznych zakończonych powodzeniem,
- 46 pliki CSV w `data/master`,
- 11691 rekordów danych,
- 51 relacje między tabelami,
- 25 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 3565 obserwacji w `configuration_attribute_values.csv`,
...
- 5905 rekordów w `configuration_attribute_availability.csv`,
- 4591 rekordów `standard`, 514 `optional`, 800 `not_available` i 0 `unknown`,
- 385 kanonicznych atrybutów w 30 kategoriach,
- baza SQLite obejmująca 46 tabele i 11691 rekordów,
