...
- 586 testów automatycznych zakończonych powodzeniem,
- 37 pliki CSV w `data/master`,
- 5155 rekordów danych,
- 34 relacje między tabelami,
- 21 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 1204 obserwacji w `configuration_attribute_values.csv`,
- 71 wersjonowanych specyfikacji w `data/imports/configuration_values`,
- 144 obserwacji w `configuration_attribute_value_ranges.csv`,
- 19 wersjonowanych specyfikacji w `data/imports/configuration_value_ranges`,
- 2977 rekordów w `configuration_attribute_availability.csv`,
- 2401 rekordów `standard`, 196 `optional`, 380 `not_available` i 0 `unknown`,
- 357 kanonicznych atrybutów w 30 kategoriach,
- baza SQLite obejmująca 37 tabele i 5155 rekordów,
