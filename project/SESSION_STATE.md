...
- 451 testów automatycznych zakończonych powodzeniem,
- 34 pliki CSV w `data/master`,
- 3346 rekordów danych,
- 34 relacje między tabelami,
- 19 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 724 obserwacji w `configuration_attribute_values.csv`,
- 44 wersjonowanych specyfikacji w `data/imports/configuration_values`,
...
- baza SQLite obejmująca 34 tabele i 3346 rekordów,
