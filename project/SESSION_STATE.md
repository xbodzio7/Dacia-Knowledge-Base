...
- 1618 testów automatycznych zakończonych powodzeniem,
- 46 pliki CSV w `data/master`,
- 11190 rekordów danych,
- 51 relacje między tabelami,
- 25 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 3335 obserwacji w `configuration_attribute_values.csv`,
- 126 wersjonowanych specyfikacji w `data/imports/configuration_values`,
- 274 obserwacji w `configuration_attribute_value_ranges.csv`,
- 21 wersjonowanych specyfikacji w `data/imports/configuration_value_ranges`,
...
- baza SQLite obejmująca 46 tabele i 11190 rekordów,
