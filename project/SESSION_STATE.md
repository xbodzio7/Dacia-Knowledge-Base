...
- 1587 testów automatycznych zakończonych powodzeniem,
- 46 pliki CSV w `data/master`,
- 11156 rekordów danych,
- 51 relacje między tabelami,
- 25 reguł statusów,
- walidator repozytorium w wersji 0.10,
- 3301 obserwacji w `configuration_attribute_values.csv`,
- 121 wersjonowanych specyfikacji w `data/imports/configuration_values`,
...
- baza SQLite obejmująca 46 tabele i 11156 rekordów,
