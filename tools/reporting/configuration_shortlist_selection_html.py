...
_SELECTION_PANEL = r'''  <section id="selection-panel" class="selection-panel" aria-labelledby="selection-heading">
  ...
  <section id="comparison-panel" class="comparison-panel" aria-labelledby="comparison-heading" hidden>
    ...
    <p>Kolor tła wskazuje wartości, które różnią się między wybranymi wariantami. Tabela może być przewijana poziomo.</p>
...
.comparison-panel{scroll-margin-top:18px;padding:18px;margin-top:18px;background:var(--panel);border:1px solid var(--line);border-radius:16px;box-shadow:0 10px 28px rgba(27,43,33,.06)}.comparison-heading-row{display:flex;align-items:start;justify-content:space-between;gap:16px}.comparison-scroll{max-width:100%;overflow:auto;margin-top:14px;border:1px solid var(--line);border-radius:12px}.comparison-table{width:max-content;min-width:100%;border-collapse:separate;border-spacing:0;background:#fff;font-size:.78rem}.comparison-table th,.comparison-table td{min-width:190px;padding:10px 12px;border-right:1px solid var(--line);border-bottom:1px solid var(--line);vertical-align:top}.comparison-table th:first-child{position:sticky;left:0;z-index:2;min-width:180px;background:var(--paper);text-align:left}.comparison-table thead th{position:sticky;top:0;z-index:1;background:var(--soft);text-align:left}.comparison-table thead th:first-child{z-index:3}.comparison-table thead span{display:block;margin-top:3px;color:var(--muted);font-family:ui-monospace,SFMono-Regular,Menlo,monospace;font-size:.66rem;font-weight:500;overflow-wrap:anywhere}.comparison-table .is-different{background:var(--warn-soft)}.comparison-model-thumbnail{display:block;width:120px;max-width:100%;margin:0 auto 5px;color:#65736a}.comparison-model-thumbnail svg{display:block;width:100%;height:auto}
...
.native-model-select,.native-equipment-select{display:none!important}.model-picker{display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px}.model-choice{position:relative;display:grid!important;grid-template-rows:74px auto;align-items:center;justify-items:center;gap:4px;min-height:112px!important;padding:8px!important;background:#fff!important;color:var(--ink)!important;text-align:center}.model-choice-thumb{display:block;width:116px;max-width:100%;color:#65736a}.model-choice svg,.model-thumbnail-host svg{display:block;width:100%;height:auto}.car-body{fill:#dfe6e1;stroke:currentColor;stroke-width:2}.car-window{fill:#aebbb3;stroke:currentColor;stroke-width:1.2}.car-line{fill:none;stroke:currentColor;stroke-width:1.2}.car-wheel{fill:#27322c}.car-hub{fill:#cbd5ce}.model-choice-check{position:absolute;top:7px;right:8px;display:none;width:22px;height:22px;border-radius:999px;background:var(--accent);color:#fff;line-height:22px}.model-choice.is-selected{border-color:var(--accent)!important;background:var(--soft)!important;box-shadow:0 0 0 2px rgba(31,111,67,.12)}.model-choice.is-selected .model-choice-check{display:block}.model-thumbnail-host{width:100%;max-height:128px;overflow:hidden;padding:4px 18px 0;color:#65736a;background:linear-gradient(180deg,var(--paper),transparent);border-radius:10px}.model-thumbnail-host svg{max-height:120px}
.equipment-picker{display:grid;gap:9px;width:100%}.equipment-picker-search{display:grid;gap:5px}.equipment-picker-search input{min-height:38px}.equipment-availability-note{margin:0!important;color:var(--muted);font-size:.72rem;font-weight:600}.equipment-availability-note.has-removal{color:var(--warn)}.equipment-picker-scroll{display:grid;gap:10px;max-height:430px;overflow:auto;padding:10px;border:1px solid var(--line);border-radius:10px;background:#fff}.equipment-picker-group{display:grid;gap:6px}.equipment-picker-group h3{margin:0;color:var(--muted);font-size:.72rem;text-transform:uppercase;letter-spacing:.05em}.equipment-picker-options{display:flex;flex-wrap:wrap;gap:6px}.equipment-choice{display:inline-flex;align-items:center;gap:6px;width:auto!important;min-height:34px!important;padding:5px 9px!important;background:#fff!important;color:var(--ink)!important;font-size:.72rem;font-weight:700!important;text-align:left}.equipment-choice span{display:none}.equipment-choice.is-selected{border-color:var(--accent)!important;background:var(--soft)!important;color:var(--accent)!important;box-shadow:0 0 0 2px rgba(31,111,67,.10)}.equipment-choice.is-selected span{display:inline}.selected-filter-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:5px}.selected-filter-actions button[aria-pressed="true"]{border-color:var(--accent);background:var(--soft);color:var(--accent)}.commercial-offers{padding:8px 0;border-top:1px solid var(--line)}.commercial-offers ul{display:grid;gap:7px;margin:8px 0 0;padding:0;list-style:none}.commercial-offers li{display:flex;justify-content:space-between;gap:10px;padding:7px;border-radius:8px;background:var(--paper)}.commercial-offers li div{display:grid;gap:2px}.commercial-offers li span{color:var(--muted);font-size:.7rem}.commercial-offers li b{white-space:nowrap;color:var(--accent)}
@media(max-width:760px){.selection-panel{position:static;grid-template-columns:1fr}.selection-actions{justify-content:flex-start}.selected-list{grid-column:auto}.comparison-heading-row{display:grid}.model-picker{grid-template-columns:repeat(2,minmax(0,1fr))}}
@media print{.selection-panel,.selection-toggle,.selected-filter-summary,.comparison-heading-row button{display:none!important}.comparison-panel{box-shadow:none}}
'''
...
def render_html(catalog: Mapping[str, Any]) -> str:
    ...
    rendered = rendered.replace(
        ...
        "Format interaktywnej shortlisty HTML v1.3.",
        1,
    )
    rendered = rendered.replace(
        body_marker,
