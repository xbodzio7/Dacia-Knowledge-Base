...
_SELECTION_PANEL = r'''  <section id="selection-panel" class="selection-panel" aria-labelledby="selection-heading">
  ...
  <section id="comparison-panel" class="comparison-panel" aria-labelledby="comparison-heading" hidden>
    ...
    <p>Porównanie obejmuje dane podstawowe, wszystkie zapisane parametry techniczne, wymiary, masy, pojemności, osiągi oraz całe wyposażenie opisane w bazie. Kolor tła wskazuje różnice; tabela może być przewijana poziomo.</p>
...
.equipment-picker{display:grid;gap:9px;width:100%}.equipment-picker-search{display:grid;gap:5px}.equipment-picker-search input{min-height:38px}.equipment-availability-note{margin:0!important;color:var(--muted);font-size:.72rem;font-weight:600}.equipment-availability-note.has-removal{color:var(--warn)}.equipment-picker-scroll{display:grid;gap:10px;max-height:520px;overflow:auto;padding:10px;border:1px solid var(--line);border-radius:10px;background:#fff}.equipment-picker-group{display:grid;gap:6px}.equipment-picker-group h3{margin:0;color:var(--muted);font-size:.72rem;text-transform:uppercase;letter-spacing:.05em}.equipment-picker-options{display:flex;flex-wrap:wrap;gap:6px}.equipment-choice[hidden]{display:none!important}.equipment-choice{display:inline-flex;align-items:center;gap:6px;width:auto!important;min-height:34px!important;padding:5px 9px!important;background:#fff!important;color:var(--ink)!important;font-size:.72rem;font-weight:700!important;text-align:left}.equipment-choice span{display:none}.equipment-choice.is-selected{border-color:var(--accent)!important;background:var(--soft)!important;color:var(--accent)!important;box-shadow:0 0 0 2px rgba(31,111,67,.10)}.equipment-choice.is-selected span{display:inline}.selected-filter-actions{display:flex;flex-wrap:wrap;justify-content:flex-end;gap:5px}.selected-filter-actions button[aria-pressed="true"]{border-color:var(--accent);background:var(--soft);color:var(--accent)}.commercial-offers{padding:8px 0;border-top:1px solid var(--line)}.commercial-offers ul{display:grid;gap:7px;margin:8px 0 0;padding:0;list-style:none}.commercial-offers li{display:flex;justify-content:space-between;gap:10px;padding:7px;border-radius:8px;background:var(--paper)}.commercial-offers li div{display:grid;gap:2px}.commercial-offers li span{color:var(--muted);font-size:.7rem}.commercial-offers li b{white-space:nowrap;color:var(--accent)}

.native-config-choice{display:none!important}.config-choice-picker{display:flex;flex-wrap:wrap;gap:10px}.config-choice{position:relative;display:inline-flex!important;align-items:center;justify-content:center;width:auto!important;min-width:150px;min-height:48px!important;padding:10px 38px 10px 14px!important;border:1px solid var(--config-line)!important;border-radius:4px!important;background:var(--config-panel)!important;color:var(--config-text)!important;font-size:.84rem;font-weight:750;text-align:left}.config-choice:hover{border-color:#b9c39d!important}.config-choice.is-selected{border-color:#b9c39d!important;background:#505747!important;color:#fff!important}.config-choice-check{position:absolute;top:-8px;right:-8px;display:none;width:24px;height:24px;border-radius:999px;background:#78836b;color:#fff;line-height:24px;text-align:center;box-shadow:0 0 0 3px var(--config-bg)}.config-choice.is-selected .config-choice-check{display:block}.config-choice-picker-versions .config-choice{min-width:180px}.config-choice-picker-powertrains .config-choice{min-width:145px}
.vehicle-photo-frame,.vehicle-photo-fallback-only{position:relative;display:grid;place-items:center;width:100%;min-height:108px}.vehicle-photo{position:relative;z-index:2;display:block;width:100%;height:100%;max-height:165px;object-fit:contain;opacity:0}.vehicle-photo-frame.has-photo .vehicle-photo{opacity:1}.vehicle-photo-fallback{position:absolute;inset:0;z-index:1;display:grid;place-items:center}.vehicle-photo-frame.has-photo .vehicle-photo-fallback{display:none}.vehicle-photo-source{position:absolute;right:5px;bottom:1px;z-index:3;padding:2px 5px;border-radius:3px;background:rgba(21,25,24,.72);color:#fff;font-size:.54rem;font-weight:650;letter-spacing:.02em}.model-media-source a{color:var(--accent)}
.model-picker{grid-template-columns:repeat(auto-fit,minmax(220px,1fr))}.model-choice{grid-template-rows:128px auto;min-height:176px!important;border-color:var(--config-line)!important;background:var(--config-panel)!important;color:var(--config-text)!important}.model-choice:hover{border-color:#b9c39d!important}.model-choice.is-selected{border-color:#b9c39d!important;background:#505747!important;box-shadow:none}.model-choice-check{background:#78836b;box-shadow:0 0 0 3px var(--config-bg)}.model-choice-thumb{width:205px}.model-choice .vehicle-photo-source{display:none}
