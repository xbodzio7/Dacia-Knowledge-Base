...
<header>
  ...
  <p class="lede">Snapshot źródłowy na dzień <strong>{catalog['as_of']}</strong>. Oficjalne zdjęcia modeli są pobierane z serwisu Dacia Polska; bez internetu pozostaje lokalna sylwetka zastępcza.</p>
</header>
<main>
