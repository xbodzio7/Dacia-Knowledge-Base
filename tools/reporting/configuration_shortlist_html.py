...
<main>
  ...
  <form id="filters" class="filters">
    <h2>Filtry</h2>
    <label class="wide">Wyszukaj
      <input id="search" type="search" placeholder="konfiguracja, model, wersja lub napęd">
    </label>
    <label>Modele
      <select id="models" multiple size="4"></select>
    </label>
    <label>Wersje
      <select id="versions" multiple size="4"></select>
    </label>
    <label>Skrzynie
      <select id="transmissions" multiple size="2"></select>
    </label>
    <label>Napędy — fragmenty oddzielone przecinkami
      <input id="powertrains" type="text" placeholder="Eco-G, Hybrid">
    </label>
  ...
  <section class="audit" aria-labelledby="audit-heading">
    <h2 id="audit-heading">Jawność wykluczeń i braków</h2>
    <p id="missing-equipment"></p>
    <p id="exclusion-reasons"></p>
  </section>
