...
for name in (
    "dacia-knowledge-base-data-products-v1.15.0.zip",
...
receipt = {
    "version": 1,
    "kind": "data_products_v1_15_0_publication",
    ...
    "consumer_interface": {
        ...
        "source_coverage_workspace_card": "Source coverage matrix",
    ...
    "assets": assets,
    "public_v1_14_1_immutable": True,
}
(ROOT / "data/reporting/data_products_v1_15_0_publication.json").write_text(
...
state["phase"] = "Data Products v1.15.0 Publication"
state["reference_delivery"] = {
    "name": "Data Products v1.15.0 Publication",
    "pull_request": PUBLICATION_PR,
    "head_sha": SOURCE_SHA,
    "quality_run": PUBLICATION_RUN_ID,
}
state["current_package"] = {
    "package_id": "data_products_v1_15_0_publication_001",
    "kind": "data_product_release",
    "name": "Data Products v1.15.0 Publication",
    "status": "complete",
    "goal": (
        "Publish immutable data-products-v1.15.0 assets from the exact "
    ...
    "manifest_paths": [
        "data/reporting/data_products_v1_15_0_publication.json",
        "project/STATE_SUMMARY.md",
        "project/packages/data-products-v1.15.0-publication-20260804.md",
        "project/state.json",
        "tools/reporting/portfolio_source_coverage_matrix_release_integration.py",
        "tools/reporting/data_product_release_download.py",
        "tools/reporting/data_product_workspace_index.py",
    ],
}
state["next_package"] = {
    "package_id": "post_v1_15_0_release_priority_selection_review_001",
    "kind": "priority_selection_review",
    "name": "Post-v1.15.0 Release Priority Selection Review",
    "status": "planned",
    "goal": (
        "Inspect canonical product, source and roadmap evidence after "
        "v1.15.0 publication and select one bounded next package without "
...
publication_doc = f"""# Data Products v1.15.0 Publication

Date: {PUBLISHED_ON}

## Result

The immutable `data-products-v1.15.0` release was published from exact source commit `{SOURCE_SHA}`.

The release adds the verified portfolio source coverage matrix in JSON, CSV and standalone HTML. The offline consumer workspace exposes the direct `source_coverage_matrix_html` entry point and dedicated **Source coverage matrix** card alongside the existing family-summary, family-comparison and model-version entry points and cards.
...
The public `data-products-v1.14.1` release remains immutable. No source data, master data, reporting scope, source quality score, source ranking, configuration pair, cross-scope pair, recommendation or inferred value changed.
...
Exact sizes and SHA-256 values are stored in `data/reporting/data_products_v1_15_0_publication.json`.

## Next package

`post_v1_15_0_release_priority_selection_review_001` selects one bounded next package from canonical repository evidence.
"""
(ROOT / "project/packages/data-products-v1.15.0-publication-20260804.md").write_text(
    publication_doc,
    encoding="utf-8",
)
