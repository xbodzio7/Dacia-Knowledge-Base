...
SCRIPT_COMMANDS = {
    ...
    "bigster-technical-page20-unresolved-review-chunk2": (
        "bigster_technical_page20_unresolved_review_chunk2.py",
        "Review chunk 2 of unresolved Bigster page-20 technical candidates by visual row boundaries.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    ...
    "duster-mini-technical-page21-ambiguity-review": (
        "duster_mini_technical_page21_ambiguity_review.py",
        "Review the Duster mini-brochure page-21 steering ambiguity against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "duster-mini-equipment-page23-ambiguity-review": (
        "duster_mini_equipment_page23_ambiguity_review.py",
        "Review the Duster mini-brochure page-23 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "duster-mini-equipment-page22-ambiguity-review": (
        "duster_mini_equipment_page22_ambiguity_review.py",
        "Review the Duster mini-brochure page-22 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "bigster-equipment-page22-ambiguity-review": (
        "bigster_equipment_page22_ambiguity_review.py",
        "Review the Bigster brochure page-22 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "jogger-equipment-page20-ambiguity-review": (
        "jogger_equipment_page20_ambiguity_review.py",
        "Review the Jogger brochure page-20 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "bigster-equipment-page21-ambiguity-review": (
        "bigster_equipment_page21_ambiguity_review.py",
    ...
    "sandero-equipment-page18-ambiguity-review": (
        "sandero_equipment_page18_ambiguity_review.py",
        "Review the Sandero brochure page-18 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "sandero-equipment-page19-ambiguity-review": (
        "sandero_equipment_page19_ambiguity_review.py",
        "Review the Sandero brochure page-19 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
    "sandero-stepway-equipment-page18-ambiguity-review": (
        "sandero_stepway_equipment_page18_ambiguity_review.py",
        "Review the Sandero Stepway brochure page-18 equipment ambiguity package against exact evidence.",
        "[--prioritization FILE] [--json FILE] [--markdown FILE] [--verify]",
    ),
