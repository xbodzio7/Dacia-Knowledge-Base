#!/usr/bin/env python3
"""Close reporting dependencies resolved by the Stepway Expression source-gap import."""
...
TARGET_CONFIGURATION = "sandero_stepway_iii_expression_ecog120_manual"
TARGET_SOURCE = "src_pl_sandero_stepway_expression_ecog120_mt_20260626"
TARGETS = {
    ("ground_clearance", ""),
    ("max_torque_rpm", "lpg"),
...
def check() -> None:
    ...
    print("Stepway Expression reporting dependencies: PASS")
