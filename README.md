...
Komenda sprawdza strukturę repozytorium, kodowanie UTF-8 i strukturę plików CSV, unikalność kluczy `id` i `code` we wszystkich tabelach oraz relacje między tabelami.
